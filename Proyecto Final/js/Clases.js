class PlazoFijos {
    ...
    // METODO PARA CALCULAR EL IMPORTE QUE REDITUA EL PLAZO FIJO EN DOLARES

    calcularTasaDolar (dolar) {

        return ((((this.importe * (this.tasaInteres/ 100)) / 365) * this.dias)/dolar).toFixed(2)
    ...
    //METODO QUE AGREGA EL HTML A LA DERECHA DE LOS PLAZOS FIJOS NUEVOS
    agregarPlazosFijosDerecha(indice, dolar){
        return `
        ...
        <div>
          ...
          <small class="text-muted">Rendimiento pesos: $${this.calcularTasa()}</small>
          <small class="text-muted">Rendimiento dolar: US$${this.calcularTasaDolar(dolar)}</small>
    ...
    //METODO QUE AGREGA EL HTML DEL BOTON NUEVO
    mostrarPlazosFijosNuevos(indice, solidario){
        return `
        ...
        <div class="card-body">
          ...
          <p class="card-text">Rendimiento en pesos: $${this.calcularTasa()}</p>
          <p class="card-text">Rendimiento en dolares: US$${this.calcularTasaDolar(solidario)}</p>           
    ...
    //METODO QUE AGREGA EL HTML DEL BOTON HISTORIAL
    mostrarHistorial(solidario) {
        return `
    ...
    //METODO QUE DEVUELVE EL NOMBRE DE LA CLASE DE CADA OBJETO
    getClassName() {
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="card-text">Rendimiento a Generar en Pesos: $${objeto.objeto.calcularTasa()}</p>
...
const plazoFijoT1 = new Tradicional(100000, 30, new Date("04/01/2021"))
const plazoFijoT2 = new Tradicional(150000, 40, new Date("06/01/2021"))
const plazoFijoT3 = new Tradicional(250000, 20, new Date("08/01/2021"))
const plazoFijoT4 = new Tradicional(350000, 15, new Date("09/01/2021"))

const plazoFijoC1 = new Precancelable(50000, 30, false, new Date("08/01/2021"))
const plazoFijoC2 = new Precancelable(250000, 40, false, new Date("08/01/2021"))
const plazoFijoC3 = new Precancelable(125000, 20, false, new Date("11/01/2021"))
const plazoFijoC4 = new Precancelable(550000, 15, false, new Date("12/01/2021"))
